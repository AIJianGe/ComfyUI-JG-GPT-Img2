...
class JiangeGPTImage2Official4KNode:
    ...
    def generate(self, **kwargs):
        ...
        images = [kwargs.get(f"🖼️ 参考图{i}") for i in range(1, ref_count + 1) if kwargs.get(f"🖼️ 参考图{i}") is not None]
...
NODE_CLASS_MAPPINGS = {
    "GPT_Image_2_官方4K": JiangeGPTImage2Official4KNode,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    "GPT_Image_2_官方4K": "⚔️GPT_Image_2_官方4K",
}
