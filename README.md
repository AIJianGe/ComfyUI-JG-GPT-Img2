...
支持多种分辨率和宽高比：\
\
这里的比例我列的比较全面，有些不支持。具体可以看API中支持的分辨率，我看柏拉图和珍珍都是同一样api文档。<https://gpt-best.apifox.cn/api-447258891>
